...
class PlacesViewModel : ViewModel() {
    ...
    var historyPlacesList: MutableLiveData<List<PlacesHistory>> = MutableLiveData()

    init {
        historyPlacesList.value = PlacesData.getHistoryPlaces()
    }

    fun getListHistoryPlaces() = historyPlacesList
